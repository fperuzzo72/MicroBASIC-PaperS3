...
#ifndef LANGUAGEHEURISTICS
#define HASAPPLE1
/* #define HASARDUINOIO */  /* MicroBASIC: I/O de pinos -- sem uso aqui, arrasta ~10 funcoes */
#define HASFILEIO
/* #define HASTONE */  /* MicroBASIC: PLAY/tone -- sem buzzer */
/* #define HASPULSE */  /* MicroBASIC: PULSE -- sem uso */
#define HASSTEFANSEXT
#define HASERRORMSG
#define HASFLOAT
/* #define HASGRAPH */  /* MicroBASIC: LINE/CIRCLE/etc -- reativar junto com SCREEN 4 */
#define HASDARTMOUTH
/* #define HASDARKARTS */  /* MicroBASIC: MALLOC/FIND/EVAL -- automodificacao, nao queremos */
/* #define HASIOT */  /* MicroBASIC: Wi-Fi, MQTT, sensores -- o Wi-Fi aqui e do wifi_sync */
#define HASMULTIDIM
/* #define HASTIMER */  /* MicroBASIC: AFTER/EVERY */
/* #define HASEVENTS */  /* MicroBASIC: EVENT */
...
#define HASLOOPOPT
#define HASNUMSYSTEM
/* #define HASCAMERA */  /* MicroBASIC: esp32cam */
#endif
